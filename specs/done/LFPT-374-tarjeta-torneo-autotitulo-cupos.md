...
## Статус
done — задеплоено в prod, [PR #382](https://github.com/UstinKO/padel-core-service/pull/382), деплой подтверждён успешным ([run 34938758099](https://github.com/UstinKO/padel-core-service/actions/runs/34938758099), commit `6f35381`)
