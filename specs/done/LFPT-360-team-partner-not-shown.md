...
## Статус
done — смержено в [PR #361](https://github.com/UstinKO/padel-core-service/pull/361), деплой подтверждён успешным ([run #245](https://github.com/UstinKO/padel-core-service/actions/runs/34762137953)).
